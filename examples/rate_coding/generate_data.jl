...
filename = "examples/rate_coding/data/examples_data.jld2"
...
if isfile(filename)
    # first load, then overwrite as desired, then save back
    @load filename input_rates input_rates2d output_rates output_rates2 output_rates3 output_rates4 output_rates5 log_6 log_7 log_8
end
...
println("\n\n ========== EXPERIMENT 6 ========== \n\n")
tspan_long = (0,3600)
log_6 = run_experiment(deepcopy(net3), tspan_long, (A=(population_size, 25.0), B=(population_size, 25.0), C=(population_size, 25.0)))

println("\n\n ========== EXPERIMENT 7 ========== \n\n")
tspan_long = (0,3600)
log_7 = run_experiment(deepcopy(net4), tspan_long, (A=(population_size, 25.0), B=(population_size, 25.0), C=(population_size, 25.0)))

println("\n\n ========== EXPERIMENT 8 ========== \n\n")
tspan_long = (0,3600)
log_8 = run_experiment(deepcopy(net5), tspan_long, (A=(population_size, 25.0), B=(population_size, 25.0), C=(population_size, 25.0)))

@save filename input_rates input_rates2d output_rates output_rates2 output_rates3 output_rates4 output_rates5 log_6 log_7 log_8
