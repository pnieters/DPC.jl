...
syn_set_1 = filter(x->(x.object==:syn_set_1), logger.data)
syn_set_2 = filter(x->(x.object==:syn_set_2), logger.data)
syn_set_3 = filter(x->(x.object==:syn_set_3), logger.data)
syn_set_4 = filter(x->(x.object==:syn_set_4), logger.data)
syn_set_5 = filter(x->(x.object==:syn_set_5), logger.data)

syn_reset_1 = filter(x->(x.object==:syn_reset_1), logger.data)
syn_reset_2 = filter(x->(x.object==:syn_reset_2), logger.data)
syn_reset_3 = filter(x->(x.object==:syn_reset_3), logger.data)
syn_reset_4 = filter(x->(x.object==:syn_reset_4), logger.data)
syn_reset_5 = filter(x->(x.object==:syn_reset_5), logger.data)

syn_read_1 = filter(x->(x.object==:syn_read_1), logger.data)
syn_read_2 = filter(x->(x.object==:syn_read_2), logger.data)
syn_read_3 = filter(x->(x.object==:syn_read_3), logger.data)
syn_read_4 = filter(x->(x.object==:syn_read_4), logger.data)
syn_read_5 = filter(x->(x.object==:syn_read_5), logger.data)

seg_read_1 = filter(x->(x.object==:seg_readout_1), logger.data)
seg_read_2 = filter(x->(x.object==:seg_readout_2), logger.data)
seg_read_3 = filter(x->(x.object==:seg_readout_3), logger.data)
seg_read_4 = filter(x->(x.object==:seg_readout_4), logger.data)
seg_read_5 = filter(x->(x.object==:seg_readout_5), logger.data)
...
steps!(ax1, [0;syn_set_1.t;1000],    0 .+ 0.9 .* [0;Int.(syn_set_1.state);0],   fill=RGBAf0(1,0,0,0.5))
steps!(ax1, [0;syn_reset_1.t;1000],  0 .+ 0.9 .* [0;Int.(syn_reset_1.state);0], fill=RGBAf0(0,0,1,0.5))
linesegments!(ax1, repeat(n1_spikes.t,inner=2), repeat(     [0,0.9], outer=length(n1_spikes.t)))

steps!(ax1, [0;syn_set_2.t;1000],    1 .+ 0.9 .* [0;Int.(syn_set_2.state);0],   fill=RGBAf0(1,0,0,0.5))
steps!(ax1, [0;syn_reset_2.t;1000],  1 .+ 0.9 .* [0;Int.(syn_reset_2.state);0], fill=RGBAf0(0,0,1,0.5))
linesegments!(ax1, repeat(n2_spikes.t,inner=2), repeat(1 .+ [0,0.9], outer=length(n2_spikes.t)))

steps!(ax1, [0;syn_set_3.t;1000],    2 .+ 0.9 .* [0;Int.(syn_set_3.state);0],   fill=RGBAf0(1,0,0,0.5))
steps!(ax1, [0;syn_reset_3.t;1000],  2 .+ 0.9 .* [0;Int.(syn_reset_3.state);0], fill=RGBAf0(0,0,1,0.5))
linesegments!(ax1, repeat(n3_spikes.t,inner=2), repeat(2 .+ [0,0.9], outer=length(n3_spikes.t)))

steps!(ax1, [0;syn_set_4.t;1000],    3 .+ 0.9 .* [0;Int.(syn_set_4.state);0],   fill=RGBAf0(1,0,0,0.5))
steps!(ax1, [0;syn_reset_4.t;1000],  3 .+ 0.9 .* [0;Int.(syn_reset_4.state);0], fill=RGBAf0(0,0,1,0.5))
linesegments!(ax1, repeat(n4_spikes.t,inner=2), repeat(3 .+ [0,0.9], outer=length(n4_spikes.t)))

steps!(ax1, [0;syn_set_5.t;1000],    4 .+ 0.9 .* [0;Int.(syn_set_5.state);0],   fill=RGBAf0(1,0,0,0.5))
steps!(ax1, [0;syn_reset_5.t;1000],  4 .+ 0.9 .* [0;Int.(syn_reset_5.state);0], fill=RGBAf0(0,0,1,0.5))
